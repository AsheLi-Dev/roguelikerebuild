...
const BIOME_ROOM_THEME_BY_INDEX = Object.freeze({
  ...
  2: FOREST_VARIANTS.SWAMP,
  3: FOREST_VARIANTS.SWAMP,
  4: FOREST_VARIANTS.DEAD_FOREST,
  5: FOREST_VARIANTS.DEAD_FOREST,
  6: FOREST_VARIANTS.DEAD_FOREST,
  7: FOREST_VARIANTS.MAGIC_FOREST,
  8: FOREST_VARIANTS.MAGIC_FOREST,
  9: FOREST_VARIANTS.MAGIC_FOREST
});
