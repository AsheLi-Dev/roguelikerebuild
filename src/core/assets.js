...
export async function loadAssetPack() {
  const assetSpecs = [
    ...
    ["ringIconAttackSpeed", "./assets/items/Ring Sprites/Attack Speed Ring.png"],
    ["ringIconChaosRebirth", "./assets/items/Ring Sprites/Chaos Rebirth Ring.png"],
    ["ringIconCounterattack", "./assets/items/Ring Sprites/Counterattack Ring.png"],
    ["ringIconCriticalDamage", "./assets/items/Ring Sprites/Critical Damage Ring.png"],
    ["ringIconDagger", "./assets/items/Ring Sprites/Dagger Ring.png"],
    ["ringIconDragon", "./assets/items/Ring Sprites/Dragon Ring.png"],
    ["ringIconInferno", "./assets/items/Ring Sprites/Inferno Ring.png"],
    ["ringIconLifesteal", "./assets/items/Ring Sprites/Lifesteal Ring.png"],
    ["ringIconLucky", "./assets/items/Ring Sprites/Lucky Ring.png"],
    ["ringIconMirror", "./assets/items/Ring Sprites/Mirror Ring.png"],
    ["ringIconPhantomKnife", "./assets/items/Ring Sprites/Phantom Knife Ring.png"],
    ["ringIconCriticalChance", "./assets/items/Ring Sprites/Critical Chance Ring.png"],
    ["ringIconGold", "./assets/items/Ring Sprites/Gold Ring.png"],
    ["ringIconDefense", "./assets/items/Ring Sprites/Defense Ring.png"],
    ["ringIconRecovery", "./assets/items/Ring Sprites/Recovery Ring.png"],
    ["ringIconAttack", "./assets/items/Ring Sprites/Attack Ring.png"],
    ["ringIconHealth", "./assets/items/Ring Sprites/Health Ring.png"],
    ["ringIconMovementSpeed", "./assets/items/Ring Sprites/Movement Speed Ring.png"],
    ...
    ["biomeGroundGrassB1", "./assets/biomes/openworld/grassb_1.png"],
    ["biomeGroundGrassB2", "./assets/biomes/openworld/grassb_2.png"],
    ["biomeGroundGrassC1", "./assets/biomes/openworld/grassc_1.png"],
    ["biomeGroundGrassC2", "./assets/biomes/openworld/grassc_2.png"],
    ["biomeGroundGrassE1", "./assets/biomes/openworld/grasse_1.png"],
    ["biomeGroundGrassE2", "./assets/biomes/openworld/grasse_2.png"],
    ...
    ["elementMageFireballProjectile", "./assets/Combat VFX/None Pixel VFX/Water Ice/Effect 8/fireball Idle.png"],
    ["elementMageFireballImpactVfx", "./assets/Combat VFX/None Pixel VFX/Water Ice/Effect 8/fireball End.png"],
    ["elementMageSunOrbProjectile", "./assets/Combat VFX/None Pixel VFX/Lightning/Lightning Orb/Fire Orb.png"],
    ...
    ["loyalDragonSummon", "./assets/Combat VFX/sprDragon.png"],
  ...
  const audioEntries = await Promise.all([
    ...
    ["xpPickupSfx", withVolume(await loadAudio("./assets/Audio/xp_pickup.mp3"), 0.18)],
