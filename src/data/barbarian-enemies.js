...
export const BARBARIAN_ENEMY_DEFS = Object.freeze({
  m_bar_ogre_1: createDirectionalEnemy({
    ...
    attacks: [
      { id: "bar_ogre_heavy_slash", kind: "cone", sprite: "attackBasic", telegraph: 0.72, cooldown: 2.5, minRange: 0, maxRange: 110, damageScale: 1.25, range: 228, arc: 98, hitboxTrigger: 9, windupStop: 5, activeAnimDuration: 15 / 14, rarity: "normal", weight: 1 },
      { id: "bar_ogre_quick_slash", kind: "cone", sprite: "attackAlt", telegraph: 0.64, cooldown: 2.1, minRange: 0, maxRange: 110, damageScale: 1.05, range: 214, arc: 92, hitboxTrigger: 9, windupStop: 3, activeAnimDuration: 15 / 14, rarity: "normal", weight: 1 },
      { id: "bar_ogre_double_slash", kind: "frame_synced_cone", sprite: "attackSpecial", telegraph: 0.72, cooldown: 3.1, minRange: 0, maxRange: 110, damageScale: 0.95, range: 220, arc: 98, totalFrames: 15, animFps: 14, hitFrames: [4, 10], windupStop: 2, rarity: "uncommon", weight: 0.78 },
      { id: "bar_ogre_triple_strike", kind: "frame_synced_cone", sprite: "attackHeavy", telegraph: 0.86, cooldown: 4.2, minRange: 0, maxRange: 110, damageScale: 0.8, range: 222, arc: 102, totalFrames: 15, animFps: 14, hitFrames: [4, 8, 11], windupStop: 2, rarity: "rare", weight: 0.72 },
      { id: "bar_ogre_pummel", kind: "cone", sprite: "attackPummel", telegraph: 0.34, cooldown: 4.2, minRange: 0, maxRange: 110, damageScale: 1, range: 118, arc: 88, stunDuration: 0.3, hitboxTrigger: 6, windupStop: 3, activeAnimDuration: 15 / 14, animFps: 14, rarity: "uncommon", weight: 0.8 },
  ...
  m_bar_golem_2: createDirectionalEnemy({
    ...
    attacks: [
      { id: "bar_golem_downward_slash", kind: "cone", sprite: "attackBasic", telegraph: 0.72, cooldown: 2.6, minRange: 0, maxRange: 110, damageScale: 1.2, range: 214, arc: 98, hitboxTrigger: 9, windupStop: 5, activeAnimDuration: 15 / 14, rarity: "normal", weight: 1 },
      { id: "bar_golem_upward_slash", kind: "cone", sprite: "attackAlt", telegraph: 0.72, cooldown: 2.6, minRange: 0, maxRange: 110, damageScale: 1.2, range: 214, arc: 98, hitboxTrigger: 9, windupStop: 5, activeAnimDuration: 15 / 14, rarity: "normal", weight: 1 },
  ...
  m_bar_nomad_3: createDirectionalEnemy({
    ...
    attacks: [
      { id: "bar_nomad_hammer_strike", kind: "cone", sprite: "attackBasic", telegraph: 0.6, cooldown: 2.3, minRange: 0, maxRange: 110, damageScale: 1.05, range: 194, arc: 86, knockback: 220, hitboxTrigger: 6, windupStop: 3, activeAnimDuration: 15 / 14, animFps: 14, weight: 1 },
      { id: "bar_nomad_heavy_swing", kind: "cone", sprite: "attackAlt", telegraph: 1.2, cooldown: 3.4, minRange: 0, maxRange: 110, damageScale: 1.4, range: 204, arc: 94, hitboxTrigger: 8, windupStop: 5, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.85 },
      { id: "bar_nomad_charged_strike", kind: "cone", sprite: "attackHeavy", telegraph: 1.5, cooldown: 4.8, minRange: 0, maxRange: 110, damageScale: 1.9, range: 214, arc: 92, stunDuration: 0.5, hitboxTrigger: 9, windupStop: 6, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.6 },
  ...
  m_bar_berserker_4: createDirectionalEnemy({
    ...
    attacks: [
      { id: "bar_berserker_upward_slash", kind: "cone", sprite: "attackBasic", telegraph: 0.5, cooldown: 2.1, minRange: 0, maxRange: 110, damageScale: 1.12, range: 190, arc: 92, hitboxTrigger: 6, windupStop: 3, activeAnimDuration: 15 / 14, animFps: 14, weight: 1 },
      { id: "bar_berserker_heavy_attack", kind: "cone", sprite: "attackAlt", telegraph: 0.8, cooldown: 3.1, minRange: 0, maxRange: 110, damageScale: 1.42, range: 206, arc: 96, hitboxTrigger: 8, windupStop: 5, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.82 },
      { id: "bar_berserker_double_slash", kind: "frame_synced_cone", sprite: "attackQuickShot", telegraph: 0.72, cooldown: 3.6, minRange: 0, maxRange: 110, damageScale: 1, range: 196, arc: 90, totalFrames: 15, animFps: 14, hitFrames: [6, 10], windupStop: 3, weight: 0.68 },
      { id: "bar_berserker_headshot_slash", kind: "cone_projectile", sprite: "attackHeavy", telegraph: 0.8, cooldown: 4.4, minRange: 0, maxRange: 110, damageScale: 1.35, range: 196, arc: 34, hitboxTrigger: 9, windupStop: 5, activeAnimDuration: 15 / 14, animFps: 14, speedValue: 300, projectileSize: 18, projectileDrawSize: 112, projectileRadius: 14, projectileDamageScale: 0.9, projectileSprite: "barbarianSpinningAxeProjectile", projectileSpriteFrames: 15, projectileSpriteFrameWidth: 256, projectileSpriteFrameHeight: 256, projectileSpriteCropWidth: 200, projectileSpriteCropHeight: 70, projectileSpriteFps: 18, weight: 0.64 },
      ...
      { id: "bar_berserker_slash_combo", kind: "frame_synced_cone", sprite: "attackSpecial", telegraph: 0.86, cooldown: 5, minRange: 0, maxRange: 110, damageScale: 1, range: 204, arc: 92, totalFrames: 15, animFps: 14, hitFrames: [4, 10], windupStop: 2, hitConfigs: [{ range: 204, arc: 128, damageScale: 0.92 }, { range: 212, arc: 42, damageScale: 1.45 }], weight: 0.58 },
  ...
  m_bar_barbarian_6: createDirectionalEnemy({
    ...
    sheets: {
      ...
      attacks: [
        { id: "bar_barbarian_upward_swing", kind: "cone", sprite: "attackBasic", telegraph: 0.5, cooldown: 2.05, minRange: 0, maxRange: 110, damageScale: 1.08, range: 198, arc: 92, hitboxTrigger: 6, windupStop: 3, activeAnimDuration: 15 / 14, animFps: 14, weight: 1 },
        { id: "bar_barbarian_downward_swing", kind: "cone", sprite: "attackAlt", telegraph: 0.68, cooldown: 2.25, minRange: 0, maxRange: 110, damageScale: 1.2, range: 222, arc: 108, hitboxTrigger: 8, windupStop: 5, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.92 },
        { id: "bar_barbarian_charged_swing", kind: "cone", sprite: "attackHeavy", telegraph: 0.9, cooldown: 3.2, minRange: 0, maxRange: 110, damageScale: 1.55, range: 228, arc: 118, knockback: 220, hitboxTrigger: 9, windupStop: 6, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.72 },
        { id: "bar_barbarian_double_strike", kind: "frame_synced_cone", sprite: "attackQuickShot", telegraph: 0.72, cooldown: 3.6, minRange: 0, maxRange: 110, damageScale: 1, range: 202, arc: 92, totalFrames: 15, animFps: 14, hitFrames: [6, 10], windupStop: 3, weight: 0.68 },
        { id: "bar_barbarian_axe_thrust", kind: "cone_projectile", sprite: "attackCast", telegraph: 0.62, cooldown: 4.8, minRange: 0, maxRange: 110, damageScale: 1, range: 208, arc: 28, hitboxTrigger: 6, windupStop: 3, activeAnimDuration: 15 / 14, animFps: 14, speedValue: 180, projectileSize: 28, projectileDrawSize: 176, projectileRadius: 22, projectileDamageScale: 1.15, projectileSprite: "barbarianSpinningAxeProjectile", projectileSpriteFrames: 15, projectileSpriteFrameWidth: 256, projectileSpriteFrameHeight: 256, projectileSpriteCropWidth: 200, projectileSpriteCropHeight: 70, projectileSpriteFps: 18, weight: 0.62 },
