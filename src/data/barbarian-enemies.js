...
export const BARBARIAN_ENEMY_DEFS = Object.freeze({
  m_bar_ogre_1: createDirectionalEnemy({
    ...
    attacks: [
      { id: "bar_ogre_heavy_slash", kind: "cone", sprite: "attackBasic", telegraph: 0.72, cooldown: 2.5, minRange: 35, maxRange: 185, damageScale: 1.25, range: 228, arc: 98, hitboxTrigger: 9, activeAnimDuration: 15 / 14, rarity: "normal", weight: 1 },
      { id: "bar_ogre_quick_slash", kind: "cone", sprite: "attackAlt", telegraph: 0.64, cooldown: 2.1, minRange: 30, maxRange: 185, damageScale: 1.05, range: 214, arc: 92, hitboxTrigger: 9, activeAnimDuration: 15 / 14, rarity: "normal", weight: 1 },
      { id: "bar_ogre_double_slash", kind: "frame_synced_cone", sprite: "attackSpecial", telegraph: 0.72, cooldown: 3.1, minRange: 25, maxRange: 185, damageScale: 0.95, range: 220, arc: 98, totalFrames: 15, animFps: 14, hitFrames: [4, 10], rarity: "uncommon", weight: 0.78 },
      { id: "bar_ogre_triple_strike", kind: "frame_synced_cone", sprite: "attackHeavy", telegraph: 0.86, cooldown: 4.2, minRange: 20, maxRange: 180, damageScale: 0.8, range: 222, arc: 102, totalFrames: 15, animFps: 14, hitFrames: [4, 8, 11], rarity: "rare", weight: 0.72 },
      { id: "bar_ogre_pummel", kind: "cone", sprite: "attackPummel", telegraph: 0.34, cooldown: 4.2, minRange: 0, maxRange: 125, damageScale: 1, range: 118, arc: 88, stunDuration: 0.3, hitboxTrigger: 6, activeAnimDuration: 15 / 14, animFps: 14, rarity: "uncommon", weight: 0.8 },
      ...
      { id: "bar_ogre_warcry", kind: "warcry", sprite: "attackQuickShot", telegraph: 0.62, cooldown: 8, minRange: 0, maxRange: 999, radius: 300, speedMult: 1.2, buffDuration: 3, hitboxTrigger: 7, activeAnimDuration: 15 / 14, animFps: 14, rarity: "rare", weight: 0.3 }
    ]
  }),
  m_bar_golem_2: createDirectionalEnemy({
    ...
    attacks: [
      { id: "bar_golem_downward_slash", kind: "cone", sprite: "attackBasic", telegraph: 0.72, cooldown: 2.6, minRange: 25, maxRange: 175, damageScale: 1.2, range: 214, arc: 98, hitboxTrigger: 9, activeAnimDuration: 15 / 14, rarity: "normal", weight: 1 },
      { id: "bar_golem_upward_slash", kind: "cone", sprite: "attackAlt", telegraph: 0.72, cooldown: 2.6, minRange: 25, maxRange: 175, damageScale: 1.2, range: 214, arc: 98, hitboxTrigger: 9, activeAnimDuration: 15 / 14, rarity: "normal", weight: 1 },
      { id: "bar_golem_whirlwind", kind: "frame_synced_circle", sprite: "attackHeavy", telegraph: 0.8, cooldown: 4.4, minRange: 0, maxRange: 165, damageScale: 0.95, radius: 172, totalFrames: 15, animFps: 14, hitFrames: [5, 8, 11], moveSpeedMultDuringActive: 0.3, rarity: "uncommon", weight: 0.7 },
      { id: "bar_golem_leap_slam", kind: "circle", sprite: "attackCast", telegraph: 15 / 14, cooldown: 5.8, minRange: 50, maxRange: 260, damageScale: 1.35, radius: 190, hitboxTrigger: 14, activeAnimDuration: 15 / 14, animFps: 14, leapStartFrame: 4, leapEndFrame: 10, leapSpeedMult: 2, rarity: "rare", groundImpactScale: 1, groundImpactSprite: "groundImpactLightOrange", groundImpactDuration: 0.32, weight: 0.45 },
      { id: "bar_golem_bull_charge", kind: "rolling_attack", sprite: "attackBullCharge", telegraph: 0.42, cooldown: 6.8, minRange: 40, maxRange: 280, damageScale: 0.7, radius: 46, hitboxTrigger: 0, activeDurationSec: 1.2, animFps: 14, loopDuringActive: true, accelDurationSec: 0.01, startSpeedMult: 3, endSpeedMult: 3, turnResponse: 0, hitIntervalSec: 0.1, rarity: "uncommon", weight: 0.42 },
      { id: "bar_golem_rolling_attack", kind: "rolling_attack", sprite: "attackRollingAttack", telegraph: 0.48, cooldown: 8.4, minRange: 40, maxRange: 280, damageScale: 0.7, radius: 58, hitboxTrigger: 0, activeDurationSec: 5, animFps: 14, loopDuringActive: true, accelDurationSec: 3, startSpeedMult: 1, endSpeedMult: 3, turnResponse: 2.1, hitIntervalSec: 0.12, rarity: "rare", weight: 0.32 },
      { id: "bar_golem_warcry", kind: "warcry", sprite: "attackQuickShot", telegraph: 0.62, cooldown: 8.2, minRange: 0, maxRange: 999, radius: 300, buffMode: "ally_damage", damageMult: 1.25, buffDuration: 3, hitboxTrigger: 7, activeAnimDuration: 15 / 14, animFps: 14, rarity: "rare", weight: 0.28 }
    ]
  }),
  m_bar_nomad_3: createDirectionalEnemy({
    ...
    attacks: [
      { id: "bar_nomad_hammer_strike", kind: "cone", sprite: "attackBasic", telegraph: 0.6, cooldown: 2.3, minRange: 20, maxRange: 165, damageScale: 1.05, range: 194, arc: 86, knockback: 220, hitboxTrigger: 6, activeAnimDuration: 15 / 14, animFps: 14, weight: 1 },
      { id: "bar_nomad_heavy_swing", kind: "cone", sprite: "attackAlt", telegraph: 1.2, cooldown: 3.4, minRange: 25, maxRange: 180, damageScale: 1.4, range: 204, arc: 94, hitboxTrigger: 8, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.85 },
      { id: "bar_nomad_charged_strike", kind: "cone", sprite: "attackHeavy", telegraph: 1.5, cooldown: 4.8, minRange: 25, maxRange: 185, damageScale: 1.9, range: 214, arc: 92, stunDuration: 0.5, hitboxTrigger: 9, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.6 },
  ...
  m_bar_berserker_4: createDirectionalEnemy({
    ...
    attacks: [
      { id: "bar_berserker_upward_slash", kind: "cone", sprite: "attackBasic", telegraph: 0.5, cooldown: 2.1, minRange: 20, maxRange: 155, damageScale: 1.12, range: 190, arc: 92, hitboxTrigger: 6, activeAnimDuration: 15 / 14, animFps: 14, weight: 1 },
      { id: "bar_berserker_heavy_attack", kind: "cone", sprite: "attackAlt", telegraph: 0.8, cooldown: 3.1, minRange: 25, maxRange: 175, damageScale: 1.42, range: 206, arc: 96, hitboxTrigger: 8, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.82 },
      { id: "bar_berserker_double_slash", kind: "frame_synced_cone", sprite: "attackQuickShot", telegraph: 0.72, cooldown: 3.6, minRange: 20, maxRange: 170, damageScale: 1, range: 196, arc: 90, totalFrames: 15, animFps: 14, hitFrames: [6, 10], weight: 0.68 },
      { id: "bar_berserker_headshot_slash", kind: "cone_projectile", sprite: "attackHeavy", telegraph: 0.8, cooldown: 4.4, minRange: 30, maxRange: 250, damageScale: 1.35, range: 196, arc: 34, hitboxTrigger: 9, activeAnimDuration: 15 / 14, animFps: 14, speedValue: 300, projectileSize: 18, projectileDrawSize: 112, projectileRadius: 14, projectileDamageScale: 0.9, projectileSprite: "barbarianSpinningAxeProjectile", projectileSpriteFrames: 15, projectileSpriteFrameWidth: 256, projectileSpriteFrameHeight: 256, projectileSpriteCropWidth: 200, projectileSpriteCropHeight: 70, projectileSpriteFps: 18, weight: 0.64 },
      { id: "bar_berserker_throw_swords", kind: "projectile_burst", sprite: "attackCast", telegraph: 0.5, cooldown: 5.2, minRange: 0, maxRange: 220, damageScale: 0.82, radius: 58, hitboxTrigger: 7, activeAnimDuration: 15 / 14, animFps: 14, projectileCount: 8, random360: true, speedValue: 280, projectileSize: 18, projectileDrawSize: 112, projectileRadius: 14, boomerang: true, returnAfter: 180, returnSpeedMult: 1.2, projectileSprite: "barbarianSpinningAxeProjectile", projectileSpriteFrames: 15, projectileSpriteFrameWidth: 256, projectileSpriteFrameHeight: 256, projectileSpriteCropWidth: 200, projectileSpriteCropHeight: 70, projectileSpriteFps: 18, weight: 0.52 },
      { id: "bar_berserker_engage", kind: "engage", sprite: "attackKick", telegraph: 0.5, cooldown: 8.5, minRange: 0, maxRange: 999, hpSacrificePct: 0.2, speedMult: 1.5, buffDuration: 5, hitboxTrigger: 7, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.36 },
      { id: "bar_berserker_slash_combo", kind: "frame_synced_cone", sprite: "attackSpecial", telegraph: 0.86, cooldown: 5, minRange: 20, maxRange: 180, damageScale: 1, range: 204, arc: 92, totalFrames: 15, animFps: 14, hitFrames: [4, 10], hitConfigs: [{ range: 204, arc: 128, damageScale: 0.92 }, { range: 212, arc: 42, damageScale: 1.45 }], weight: 0.58 },
  ...
  m_bar_archer_5: createDirectionalEnemy({
    ...
    attacks: [
      { id: "bar_archer_sniper_shot", kind: "projectile", sprite: "attackBasic", telegraph: 0.9, cooldown: 2.8, minRange: 140, maxRange: 500, damageScale: 1.15, speedValue: 720, projectileSize: 12, hitboxTrigger: 9, projectileSpawnWindupT: 9 / 14, activeAnimDuration: 15 / 14, animFps: 14, weight: 1 },
      { id: "bar_archer_arrow_volley", kind: "projectile_spin", sprite: "attackRain", telegraph: 0.62, cooldown: 3.9, minRange: 100, maxRange: 450, damageScale: 0.85, speedValue: 340, projectileSize: 13, hitboxTrigger: 9, projectileSpawnWindupT: 9 / 14, spinStartDeg: -15, spinStepDeg: 15, spinCount: 3, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.72 },
      { id: "bar_archer_running_shot", kind: "running_shot", sprite: "attackRun", telegraph: 15 / 14, cooldown: 4.8, minRange: 90, maxRange: 380, damageScale: 1, speedValue: 720, projectileSize: 12, projectileRadius: 8, hitboxTrigger: 8, activeAnimDuration: 15 / 14, animFps: 14, runSpeedMult: 3, runAngleDeg: 20, spreadDeg: 30, weight: 0.62 },
      { id: "bar_archer_spin_shot", kind: "frame_synced_projectile", sprite: "attackSpin", telegraph: 0.5, cooldown: 5.4, minRange: 80, maxRange: 430, damageScale: 0.78, speedValue: 300, projectileSize: 14, projectileRadius: 10, totalFrames: 15, animFps: 14, hitFrames: [6, 7, 8, 9, 10, 11, 12, 13], shotAnglesDeg: [45, 0, -45, -90, -135, 180, 135, 90], weight: 0.56 }
      ,{ id: "bar_archer_rain_arrow", kind: "targeted_rain_zone", sprite: "attackRain", telegraph: 0.8, cooldown: 6, minRange: 80, maxRange: 430, damageScale: 0.9, radius: 90, hitboxTrigger: 12, activeAnimDuration: 15 / 14, animFps: 14, zoneDurationSec: 3, zoneTickSec: 0.5, tickHitDuration: 0.12, weight: 0.5 }
    ]
  }),
  m_bar_barbarian_6: createDirectionalEnemy({
    ...
    sheets: {
      ...
      attacks: [
        { id: "bar_barbarian_upward_swing", kind: "cone", sprite: "attackBasic", telegraph: 0.5, cooldown: 2.05, minRange: 30, maxRange: 165, damageScale: 1.08, range: 198, arc: 92, hitboxTrigger: 6, activeAnimDuration: 15 / 14, animFps: 14, weight: 1 },
        { id: "bar_barbarian_downward_swing", kind: "cone", sprite: "attackAlt", telegraph: 0.68, cooldown: 2.25, minRange: 25, maxRange: 175, damageScale: 1.2, range: 222, arc: 108, hitboxTrigger: 8, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.92 },
        { id: "bar_barbarian_charged_swing", kind: "cone", sprite: "attackHeavy", telegraph: 0.9, cooldown: 3.2, minRange: 25, maxRange: 185, damageScale: 1.55, range: 228, arc: 118, knockback: 220, hitboxTrigger: 9, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.72 },
        { id: "bar_barbarian_double_strike", kind: "frame_synced_cone", sprite: "attackQuickShot", telegraph: 0.72, cooldown: 3.6, minRange: 20, maxRange: 175, damageScale: 1, range: 202, arc: 92, totalFrames: 15, animFps: 14, hitFrames: [6, 10], weight: 0.68 },
        { id: "bar_barbarian_axe_thrust", kind: "cone_projectile", sprite: "attackCast", telegraph: 0.62, cooldown: 4.8, minRange: 35, maxRange: 260, damageScale: 1, range: 208, arc: 28, hitboxTrigger: 6, activeAnimDuration: 15 / 14, animFps: 14, speedValue: 180, projectileSize: 28, projectileDrawSize: 176, projectileRadius: 22, projectileDamageScale: 1.15, projectileSprite: "barbarianSpinningAxeProjectile", projectileSpriteFrames: 15, projectileSpriteFrameWidth: 256, projectileSpriteFrameHeight: 256, projectileSpriteCropWidth: 200, projectileSpriteCropHeight: 70, projectileSpriteFps: 18, weight: 0.62 },
  ...
  m_bar_bowman_7: createDirectionalEnemy({
    ...
    sheets: {
      ...
      attacks: [
        { id: "bar_bowman_arrow_volley", kind: "projectile_spin", sprite: "attackBasic", telegraph: 0.72, cooldown: 2.8, minRange: 100, maxRange: 420, damageScale: 0.72, speedValue: 560, projectileSize: 10, projectileRadius: 6, hitboxTrigger: 9, projectileSpawnWindupT: 9 / 14, spinStartDeg: -45, spinStepDeg: 18, spinCount: 6, activeAnimDuration: 15 / 14, animFps: 14, weight: 1 },
        { id: "bar_bowman_charged_shot", kind: "projectile", sprite: "attackBasic", telegraph: 1.2, cooldown: 3.8, minRange: 100, maxRange: 440, damageScale: 1.45, speedValue: 760, projectileSize: 18, projectileRadius: 10, hitboxTrigger: 11, projectileSpawnWindupT: 11 / 14, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.68 },
        { id: "bar_bowman_spin_shot", kind: "frame_synced_projectile", sprite: "attackSpin", telegraph: 0.5, cooldown: 5.4, minRange: 80, maxRange: 430, damageScale: 0.78, speedValue: 300, projectileSize: 14, projectileRadius: 10, totalFrames: 15, animFps: 14, hitFrames: [6, 7, 8, 9, 10, 11, 12, 13], shotAnglesDeg: [45, 0, -45, -90, -135, 180, 135, 90], weight: 0.56 },
        { id: "bar_bowman_rain_arrow", kind: "targeted_rain_zone", sprite: "attackRain", telegraph: 0.8, cooldown: 6, minRange: 80, maxRange: 430, damageScale: 0.9, radius: 90, hitboxTrigger: 12, activeAnimDuration: 15 / 14, animFps: 14, zoneDurationSec: 3, zoneTickSec: 0.5, tickHitDuration: 0.12, weight: 0.5 },
        { id: "bar_bowman_tactical_retreat_shot", kind: "running_shot", sprite: "attackRun", telegraph: 15 / 14, cooldown: 5.4, minRange: 0, maxRange: 999, damageScale: 1.1, speedValue: 760, projectileSize: 14, projectileRadius: 8, hitboxTrigger: 8, activeAnimDuration: 15 / 14, animFps: 14, runSpeedMult: 1.5, runAngleDeg: 0, spreadDeg: 0, projectileCount: 1, weight: 0 }
        ],
    swiftStep: {
      threshold: 0.5,
      runDuration: 1.5,
