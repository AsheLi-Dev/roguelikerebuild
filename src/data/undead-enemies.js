...
export const UNDEAD_ENEMY_DEFS = Object.freeze({
  m_ud_brute: createDirectionalEnemy({
    ...
    attacks: [
      ...
      { id: "ud_brute_groundslam", kind: "circle", sprite: "attackGroundSlam", telegraph: 0.62, cooldown: 3.4, minRange: 0, maxRange: 140, damageScale: 1.15, radius: 165, hitboxTrigger: 11, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.75 },
  ...
  m_ud_warrior: createDirectionalEnemy({
    ...
    attacks: [
      ...
      { id: "ud_warrior_groundslam", kind: "circle", sprite: "attackGroundSlam", telegraph: 0.62, cooldown: 3.4, minRange: 0, maxRange: 140, damageScale: 1.15, radius: 165, hitboxTrigger: 11, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.75 }
    ]
  }),
  m_ud_archer_5: createDirectionalEnemy({
    ...
    attacks: [
      ...
      { id: "ud_archer_spin_shot", kind: "projectile_spin", sprite: "attackSpinShot", telegraph: 1, cooldown: 5.2, minRange: 80, maxRange: 430, damageScale: 0.75, speedValue: 300, projectileSize: 14, hitboxTrigger: 6, projectileSpawnWindupT: 6 / 14, spinStartDeg: 45, spinStepDeg: -45, spinCount: 8, spinFrameInterval: 1 / 14, activeAnimDuration: 15 / 14, weight: 0.55, projectileSprite: "enemyUndeadArrow" },
      ...
      { id: "ud_archer_arrow_rain", kind: "arrow_rain", sprite: "attackArrowRain", telegraph: 1, cooldown: 5.8, minRange: 80, maxRange: 430, damageScale: 1, radius: 90, hitboxTrigger: 9, rainIntervalSec: 0.2, rainDurationSec: 2, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.7 }
    ]
  }),
  ...
  m_ud_necromancer_8: createDirectionalEnemy({
    ...
    attacks: [
      ...
      { id: "ud_necromancer_summon_warrior", kind: "summon", sprite: "attackSummonWarrior", telegraph: 0.72, cooldown: 11, minRange: 40, maxRange: 480, hitboxTrigger: 9, spawnType: "m_ud_warrior", spawnForward: 220, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.4 }
    ]
  }),
  m_ud_wizard_9: createDirectionalEnemy({
    ...
    attacks: [
      { id: "ud_wizard_basic_bolt", kind: "projectile", sprite: "attackBasic", alternateSprite: "attackAlt", telegraph: 0.52, cooldown: 2, minRange: 90, maxRange: 420, damageScale: 0.95, speedValue: 300, projectileSize: 11, hitboxTrigger: 8, activeAnimDuration: 15 / 14, weight: 1 },
      ...
      { id: "ud_wizard_fire_dance", kind: "projectile_burst", sprite: "attackFireDance", telegraph: 0.58, cooldown: 7, minRange: 0, maxRange: 520, damageScale: 0.75, speedValue: 320, projectileSize: 10, projectileCount: 12, random360: true, hitboxTrigger: 14, activeAnimDuration: 15 / 14, weight: 0.3 },
      { id: "ud_wizard_fire_thrower", kind: "fire_thrower", sprite: "attackFireThrower", telegraph: 0.58, cooldown: 8, minRange: 0, maxRange: 520, damageScale: 0.55, range: 260, arc: 55, fireThrowerIntervalSec: 0.2, fireThrowerDurationSec: 2, hitboxTrigger: 8, activeAnimDuration: 15 / 14, weight: 0.28 },
      { id: "ud_wizard_fire_wave", kind: "projectile_backstep", sprite: "attackFireWave", telegraph: 0.58, cooldown: 7.5, minRange: 70, maxRange: 520, damageScale: 1.05, speedValue: 360, projectileSize: 22, backstepSpeed: 400, backstepDuration: 0.5, hitboxTrigger: 8, activeAnimDuration: 15 / 14, weight: 0.3 },
      ...
      { id: "ud_wizard_charged_fireball", kind: "projectile", sprite: "attackCast", telegraph: 0.7, cooldown: 9.5, minRange: 120, maxRange: 560, damageScale: 1.35, speedValue: 260, projectileSize: 34, projectileRadius: 30, hitboxTrigger: 8, activeAnimDuration: 15 / 14, weight: 0.22 },
