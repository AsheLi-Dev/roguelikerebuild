...
export const UNDEAD_ENEMY_DEFS = Object.freeze({
  m_ud_brute: createDirectionalEnemy({
    ...
    attacks: [
      { id: "ud_brute_downslash", kind: "cone", sprite: "attackDown", telegraph: 0.58, cooldown: 2.15, minRange: 0, maxRange: 110, damageScale: 1.12, range: 110, arc: 95, hitboxTrigger: 7, windupStop: 4, activeAnimDuration: 15 / 14, weight: 1 },
      { id: "ud_brute_upslash", kind: "cone", sprite: "attackUp", telegraph: 0.58, cooldown: 2.15, minRange: 0, maxRange: 110, damageScale: 1.12, range: 110, arc: 95, hitboxTrigger: 7, windupStop: 4, activeAnimDuration: 15 / 14, weight: 1 },
  ...
  m_ud_warrior: createDirectionalEnemy({
    ...
    attacks: [
      { id: "ud_warrior_downslash", kind: "cone", sprite: "attackDown", telegraph: 0.56, cooldown: 2.05, minRange: 0, maxRange: 110, damageScale: 1.05, range: 110, arc: 92, hitboxTrigger: 7, windupStop: 4, activeAnimDuration: 15 / 14, weight: 1 },
      { id: "ud_warrior_upslash", kind: "cone", sprite: "attackUp", telegraph: 0.56, cooldown: 2.05, minRange: 0, maxRange: 110, damageScale: 1.05, range: 110, arc: 92, hitboxTrigger: 7, windupStop: 4, activeAnimDuration: 15 / 14, weight: 1 },
      { id: "ud_warrior_kick", kind: "cone", sprite: "attackKick", telegraph: 0.42, cooldown: 2.35, minRange: 0, maxRange: 110, damageScale: 0.72, range: 110, arc: 62, knockback: 70, hitboxTrigger: 6, windupStop: 3, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.92 },
  ...
  m_ud_archer_5: createDirectionalEnemy({
    ...
    attacks: [
      ...
      { id: "ud_archer_kick", kind: "cone", sprite: "attackKick", telegraph: 0.42, cooldown: 2.35, minRange: 0, maxRange: 40, damageScale: 0.72, range: 108, arc: 62, knockback: 70, hitboxTrigger: 6, windupStop: 3, activeAnimDuration: 15 / 14, animFps: 14, weight: 0.92 },
  ...
  m_ud_berserker_4: createDirectionalEnemy({
    ...
    attacks: [
      { id: "ud_berserker_basic_slash", kind: "cone", sprite: "attackBasic", telegraph: 0.5, cooldown: 2, minRange: 0, maxRange: 110, damageScale: 1.15, range: 110, arc: 95, hitboxTrigger: 7, windupStop: 4, activeAnimDuration: 15 / 14, weight: 1 },
      { id: "ud_berserker_axe_slash", kind: "cone", sprite: "attackDown", telegraph: 0.55, cooldown: 2.7, minRange: 0, maxRange: 110, damageScale: 1.2, range: 110, arc: 120, hitboxTrigger: 9, windupStop: 5, activeAnimDuration: 15 / 14, weight: 0.8 },
      ...
      { id: "ud_berserker_fast_strike", kind: "cone", sprite: "attackCast", telegraph: 0.35, cooldown: 2.1, minRange: 0, maxRange: 110, damageScale: 0.95, range: 110, arc: 30, hitboxTrigger: 6, windupStop: 3, activeAnimDuration: 15 / 14, weight: 0.85 },
      { id: "ud_berserker_quickslash", kind: "cone", sprite: "attackQuickSlash", telegraph: 0.25, cooldown: 1.8, minRange: 0, maxRange: 110, damageScale: 0.85, range: 110, arc: 80, hitboxTrigger: 4, windupStop: 2, activeAnimDuration: 15 / 14, weight: 0.9 },
  ...
  m_ud_necromancer_8: createDirectionalEnemy({
    ...
    attacks: [
      ...
      { id: "ud_necromancer_dark_wave", kind: "cone", sprite: "attackDarkWave", telegraph: 0.55, cooldown: 2.85, minRange: 0, maxRange: 110, damageScale: 1, range: 110, arc: 78, hitboxTrigger: 7, windupStop: 4, activeAnimDuration: 15 / 14, animFps: 14, knockback: 200, weight: 0.82 },
  ...
  m_ud_dark_lord_2: createDirectionalEnemy({
    ...
    attacks: [
      { id: "ud_dark_lord_basic_cleave", kind: "cone", sprite: "attackBasic", telegraph: 0.58, cooldown: 2.3, minRange: 0, maxRange: 110, damageScale: 1.2, range: 110, arc: 100, hitboxTrigger: 7, windupStop: 4, activeAnimDuration: 15 / 14, weight: 1 },
      ...
      { id: "ud_dark_lord_shield_bash", kind: "cone", sprite: "attackShieldBash", telegraph: 0.45, cooldown: 3, minRange: 0, maxRange: 110, damageScale: 0.85, range: 110, arc: 58, hitboxTrigger: 8, windupStop: 5, activeAnimDuration: 15 / 14, weight: 0.8 },
      ...
      { id: "ud_dark_lord_double_strike", kind: "cone_combo", sprite: "attackDoubleStrike", telegraph: 0.05, cooldown: 3.1, minRange: 0, maxRange: 40, damageScale: 1, range: 180, arc: 90, sameStripComboHits: 2, sameStripComboGap: 0.05, hitboxTrigger: 4, windupStop: 2, activeAnimDuration: 15 / 14, weight: 0.8 },
  ...
  m_ud_dark_knight_3: createDirectionalEnemy({
    ...
    attacks: [
      { id: "ud_dark_knight_downslash", kind: "cone", sprite: "attackDown", telegraph: 0.5, cooldown: 2.5, minRange: 0, maxRange: 110, damageScale: 1.1, range: 110, arc: 94, hitboxTrigger: 7, windupStop: 4, activeAnimDuration: 15 / 14, weight: 0.85 },
      { id: "ud_dark_knight_upslash", kind: "cone", sprite: "attackUp", telegraph: 0.5, cooldown: 2.5, minRange: 0, maxRange: 110, damageScale: 1.1, range: 110, arc: 94, hitboxTrigger: 7, windupStop: 4, activeAnimDuration: 15 / 14, weight: 0.85 },
